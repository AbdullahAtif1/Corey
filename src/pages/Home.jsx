...
const Home = () => {
  ...
  const PHONE = "(321) 989-8673";
  const EMAIL = "astrotransportllc22@gmail.com";
  const MC_NUMBER = "1792444";
  const DOT_NUMBER = "4523214";
  const HOME_BASE = "1048 MCCLENDON ST MELBOURNE, FL 32935";
  ...
  const handleUnlock = (e) => {
    ...
    if (accessCode.toUpperCase() === 'ASTRO2026') {
      setIsUnlocked(true); setShowModal(false); setError('');
    } else { setError('Invalid Code. Try "ASTRO2026"'); }
  };
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up z-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-none tracking-tight text-gray-900">
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">Astro Transport</span> LLC<br />
            </h1>
           ...
           {/* Image Side */}
            <div className="relative group hover-lift">
              ...
              <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md px-6 py-4 border-l-4 border-red-600 shadow-lg">
                <p className="font-black text-xl uppercase text-white">COREY SMALL</p>
      ...
      <section id="lanes" className="py-20 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['FLORIDA', 'GEORGIA', 'ALABAMA', 'SOUTH CAROLINA', 'NORTH CAROLINA', 'TENNESSEE', 'MISSISSIPPI'].map((state, index) => (
                <span 
                  key={state} 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                <div className="text-left space-y-4">
                   ...
                   <p className="text-gray-400 text-lg">
                    Specializing in FLORIDA ↔ SOUTHEAST routes. Get a direct response from the owner-operator within minutes.
                   </p>
                </div>
