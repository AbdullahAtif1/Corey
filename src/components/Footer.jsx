    ...
    <footer className="bg-[var(--text-main)] text-[var(--bg-main)] py-12">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xl tracking-tighter"><span className="text-[var(--primary)]">Astro</span> Transport LLC</span>
        </div>

        <div className="text-sm opacity-60">
            © 2026 Astro Transport LLC. All Rights Reserved.
        </div>
